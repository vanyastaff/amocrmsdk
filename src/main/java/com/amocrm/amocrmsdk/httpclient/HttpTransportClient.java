package com.amocrm.amocrmsdk.httpclient;

import com.amocrm.amocrmsdk.client.ApiResponse;
import com.amocrm.amocrmsdk.client.TransportClient;
...
public class HttpTransportClient implements TransportClient {
    ...
    protected ApiResponse callWithStatusCheck(HttpRequestBase request) throws IOException {
    ...
    protected ApiResponse call(HttpRequestBase request) throws IOException {
        ...
        for (int i = 0; i < retryAttemptsNetworkErrorCount; i++) {
            try {
                ...
                try (InputStream content = response.getEntity().getContent()) {
                    ...
                    return new ApiResponse(response.getStatusLine().getStatusCode(), result, responseHeaders);
                } finally {
    ...
    @Override
    public ApiResponse get(String url, String params) throws IOException {
        return get(url, params, FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse get(String url, String params, String contentType) throws IOException {
    ...
    @Override
    public ApiResponse get(String url, String params, Header[] headers) throws IOException {
        if(params != null) url = url + '?' + params;
        HttpGet request = new HttpGet(url);
    ...
    @Override
    public ApiResponse post(String url, String params) throws IOException {
        return post(url, params, null);
    }

    @Override
    public ApiResponse post(String url, String params, String body) throws IOException {
        return post(url, params, body, FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse post(String url, String params, String body, String contentType) throws IOException {
        if(params != null) url = url + '?' + params;
    ...
    @Override
    public ApiResponse post(String url, String params, String body, Header[] headers) throws IOException {
        if(params != null) url = url + '?' + params;
        HttpPost request = new HttpPost(url);
        request.setHeader(CONTENT_TYPE_HEADER, FORM_CONTENT_TYPE);
        for (Header header : headers) {
    ...
    @Override
    public ApiResponse patch(String url) throws IOException {
        return post(url, null, null);
    }

    @Override
    public ApiResponse patch(String url, String params) throws IOException {
        return post(url, params, null);
    }

    @Override
    public ApiResponse patch(String url, String params, String body) throws IOException {
        return post(url, params, body, FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse patch(String url, String params, String body, String contentType) throws IOException {
        if(params != null) url = url + '?' + params;
    ...
    @Override
    public ApiResponse patch(String url, String params, String body, Header[] headers) throws IOException {
        if(params != null) url = url + '?' + params;
        HttpPatch request = new HttpPatch(url);
        request.setHeader(CONTENT_TYPE_HEADER, FORM_CONTENT_TYPE);
        for (Header header : headers) {
    ...
    public ApiResponse delete(String url) throws IOException {
        return delete(url, null, null,  FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse delete(String url, String params) throws IOException {
        return delete(url, null, null, FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse delete(String url, String params, String body) throws IOException {
        return delete(url, params, body, FORM_CONTENT_TYPE);
    }

    @Override
    public ApiResponse delete(String url, String params, String body, String contentType) throws IOException {
        if(params != null) url = url + '?' + params;
    ...
    @Override
    public ApiResponse delete(String url, String params, String body, Header[] headers) throws IOException {
        if(params != null) url = url + '?' + params;
        HttpDeleteWithBody request = new HttpDeleteWithBody(url);
        request.setHeader(CONTENT_TYPE_HEADER, FORM_CONTENT_TYPE);
        for (Header header : headers) {
