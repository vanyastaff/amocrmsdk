...
public class Company {
    ...
    private CompanyEmbedded embedded;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, responsibleUserId, groupId, statusId, pipelineId, lossReasonId, createdBy, updatedBy, createdAt, updatedAt, closestTaskAt, isDeleted, customFields, embedded, accountId);
    }
